...
SCRIPTS_DIR="${KINGLAB_DIR}/BIOINFORMATICS/scripts/calibrated-pe-alignment/scripts"  ## change this to where you have copied the align-to-chimera folder
...
${SCRIPTS_DIR}/create-chimera-genome.sh -s $SPIKEINGENOME_FASTA -g $GENOMEOFINTEREST_FASTA -o $OUT_DIR 
